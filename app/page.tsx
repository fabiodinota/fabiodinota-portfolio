  ...
  return (
    <div className="w-full h-full">
      <div className="h-[45%] xl:h-[60%] flex justify-center items-start flex-col pl-5 md:pl-[4vw]">
        <h1 className={`text-[70px] sm:text-[80px] xl:text-[120px] font-semibold ${colors.primary} leading-tight`}>Fabio <span className="block md:inline">Di Nota<span className={`${colors.red} inline-flex`}>.</span></span></h1>
        <p className={` ${colors.primary} text-[34px] sm:text-[40px] xl:text-[64px] flex flex-col leading-none`}>
      ...
      <div className="h-[55%] xl:h-[40%] flex flex-col-reverse xl:flex-row">
        <div className={`h-full ${colors.border} border-t-[1px] xl:border-r-[1px] w-full xl:w-[50%] flex justify-center items-center xl:flex-col p-5 gap-5`}>
          <Link
