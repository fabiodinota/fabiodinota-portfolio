	...
	return (
		<div className="flex flex-col w-full overflow-hidden items-center lg:justify-between h-full relative">
			...
			>
				...
				>
					...
					<p className="sm:text-justify sm:pb-0 font-extralight">
						I&apos;m a tech-savvy software engineer and designer
						from Antwerp, Belgium. I&apos;m passionate about all
						things tech and love doodling ideas and coding in my
						free time.
						<br />
						<br />
						I have experience with JavaScript, Typescript, React,
						Next.js, and various design tools like Figma,
						Illustrator, and Photoshop, along with video and
						animation software.
						<br />
						<br />I enjoy taking on new challenges and would be
			...
			<div
				...
				className={`${
					isOpen === 0 ? "h-full" : "h-[80px] flex-shrink-0"
				} transition-all duration-1000 custom-ease lg:hidden flex w-full flex-col justify-start items-center relative z-10 top-0`}
			>
				<div
					className={`w-full absolute z-10 top-0 left-0  flex items-center justify-between flex-shrink-0 flex-grow-0 h-[80px] px-[30px] border-b-[1px] ${colors.background} ${border} ${colors.primary}`}
				>
					<span>About Me</span>
					<span
						className={`${
							isOpen === 0 ? "rotate-[450deg]" : "rotate-[270deg]"
						} duration-500`}
					>
						<Image
				...
				<div className="relative w-full h-full overflow-y-scroll z-0 ">
					<div
						className={`w-full absolute top-[80px] left-0 ${colors.background} p-5 `}
					>
						<p
							className={`sm:text-justify sm:pb-0 font-extralight ${colors.primary}`}
						>
			...
			<div
				...
				className={`${
					isOpen === 1
						...
						: "h-[80px] flex-shrink-0"
				} transition-all duration-1000 custom-ease  lg:hidden flex w-full flex-col justify-start items-center relative z-20 top-0`}
			>
				<div
					className={`w-full absolute z-20 top-0 left-0 flex items-center justify-between flex-shrink-0 flex-grow-0 h-[80px] px-[30px] 
                    ${
						isOpen === 1
				...
				>
					...
					<span
						className={`${
							isOpen === 1 ? "rotate-[450deg]" : "rotate-[270deg]"
						} duration-500`}
					>
						<Image
							src={theme === "dark" ? Arrow_dark : Arrow_light}
				...
				<div className="relative w-full h-full overflow-y-scroll z-0 ">
					<div
						className={`w-full absolute top-[80px] space-y-5 left-0 ${colors.background} p-5`}
					>
						<ExperienceComponent
			...
			<div
				...
				className={`${
					isOpen === 2
						? "h-full overflow-y-scroll"
						: "h-[80px] flex-shrink-0"
				} transition-all duration-1000 custom-ease lg:hidden flex w-full flex-col justify-start items-center relative z-30 top-0`}
			>
				<div
					className={`w-full absolute z-30 top-0 left-0 flex items-center justify-between flex-shrink-0 flex-grow-0 h-[80px] px-[30px] border-t-[1px] ${
						isOpen === 2
							? "border-bottom-animation"
							: "border-bottom-animation-out"
					}   ${colors.background} ${border} ${colors.primary}`}
				>
					...
					<span
						className={`${
							isOpen === 2 ? "rotate-[450deg]" : "rotate-[270deg]"
						} duration-500`}
					>
						<Image
							src={theme === "dark" ? Arrow_dark : Arrow_light}
			...
			<div
				...
				} duration-700 custom-ease origin-bottom w-full flex-col justify-start items-center relative z-10 `}
			>
				<div
					onClick={() => {
				...
				<div className="h-full pb-[60px] flex flex-row w-full">
					<div className="w-1/2 overflow-y-scroll h-full">
						<div
							className={`w-full h-max p-5  space-y-5 border-r-[1px] ${border}`}
						>
							<SkillsComponent
								title="Languages"
