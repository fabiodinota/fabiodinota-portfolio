...
const rayTransition = { duration: 0.2, ease: "easeOut" as const, delay: 0.1 };
			...
			>
				<AnimatePresence mode="wait">
					<m.svg
						...
						exit="exit"
						{...hoverTapScale}
						transition={{ duration: 0.1, ...springTransition }}
						...
						{theme === "light" && (
							...
							>
								<m.circle
									...
									r="4"
								/>
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M18 11V9" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M22.9491 13.05L24.3633 11.6357" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M25 18L27 18" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M22.9491 22.95L24.3633 24.3643" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M18 27V25" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M11.6366 24.3644L13.0508 22.9502" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M9 18L11 18" strokeLinecap="round" />
								<m.path className="origin-bottom" variants={switchLightChildVariant} transition={rayTransition} stroke="black" d="M11.6366 11.6356L13.0508 13.0498" strokeLinecap="round" />
							</m.g>
						)}
					</m.svg>
				</AnimatePresence>
